...
{
    internal class GroupsManagerBinder : BinderBase<IGroupsManager>
    {
        private readonly Option<string> _endpointOption;
        private readonly Option<string> _apiKeyOption;

        public GroupsManagerBinder(Option<string> endpointOption, Option<string> apiKeyOption)
        {
            _endpointOption = endpointOption;
            _apiKeyOption = apiKeyOption;
        }

        protected override IGroupsManager GetBoundValue(BindingContext bindingContext)
        {
