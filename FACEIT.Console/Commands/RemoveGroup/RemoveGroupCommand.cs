...
namespace FACEIT.Console.Commands.RemoveGroupCommand
{
    internal class RemoveGroupCommand : Command
    {
        ...
        public RemoveGroupCommand(IFaceServiceFactory faceServiceFactory) : base("remove-group", "Remove a group")
        {
        ...
        private async Task CommandHandler(ParseResult parseResult, CancellationToken cancellationToken)
        {
            ...
            var response = await groupsManager.RemoveGroupAsync(groupId, cancellationToken);
